...
import BackendTest6 from "./../pages/backend-test-6"
import BackendTest7 from "./../pages/backend-test-7"
import BackendTest8 from "./../pages/backend-test-8"
...
const AuthedRoute: TypesArray = [
	...
	{
		path: "/backend-test-6",
		component: BackendTest6,
	},
	{
		path: "/backend-test-7",
		component: BackendTest7,
	},
	{
		path: "/backend-test-8",
		component: BackendTest8,
	},
	{
